...
<?php if (have_posts()) : ?>
  <?php while (have_posts()) : ?>
    <?php the_post(); ?>
    <section class="page-banner" style="background-image: linear-gradient(to bottom, rgba(0,0,0,.2), rgba(0,0,0,.7)), url(<?php echo get_theme_file_uri('/assets/img/professor.jpg'); ?>); background-position: center;">
      <div class="container">
        <h2><?php the_title(); ?></h2>
      </div>
    </section>
